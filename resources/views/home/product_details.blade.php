...
<head>
    ...
    <title>Male-Fashion | details</title>
...
<div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals" style="margin: auto; width :40%;  ">
    <div class="product__item">
                <div class="product__item__pic set-bg" data-setbg="product/{{ $product->image }}">

                </div>
        <div class="product__item__text" style="font-size:20px ; padding:35px">
